...
export default function Timer() {
    ...
    return (
        <div className="flex flex-col items-center gap-4 p-4 border rounded-lg bg-primary border-neutral-800">
            ...
            <button 
                onClick={isTimerActive ? resetInterview : startTimer}
            ...
            >
                {isTimerActive ? 'Stop Interview' : 'Start Interview'}
            </button>
